...
from utils.general import (
        LOGGER, NCOLS, box_iou, check_dataset, check_img_size,
        check_requirements, check_yaml, coco80_to_coco91_class,
...
def run(data,
    ...
    if training:  # called by train.py
        ...
        if pt:
            ...
            LOGGER.info(
                ...
                shape(1,3,{imgsz},{imgsz}) for non-PyTorch backends')
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        out = non_max_suppression(
            out, conf_thres, iou_thres, labels=lb,
        ...
        if plots and batch_i < 3:
            ...
            Thread(target=plot_images, args=(
                im, targets, paths, f, names), daemon=True).start()
    ...
    if not training:
        ...
        LOGGER.info(
            ...
            %.1fms NMS per image at shape {shape}' % t)
...
def parse_opt():
    ...
    parser.add_argument(
        '--data', type=str, default=ROOT / 'config.yaml',
